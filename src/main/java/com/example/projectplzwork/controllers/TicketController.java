...
import org.springframework.beans.factory.annotation.Autowired; // Fix @Autowired import
...
import java.util.Optional; // Fix Optional import
...
public class TicketController {
    ...
    public ResponseEntity<Ticket> getTicketById(@PathVariable Long id) {
        ...
        return ticket.map(ResponseEntity::ok).orElseGet(() -> ResponseEntity.notFound().build()); // Fix Optional
    }
